...
from keras.layers import Input, Conv1D, Dense, concatenate, RepeatVector, MaxPooling1D, Activation, UpSampling1D, Conv1DTranspose
...
import time #for time consumption check

def main_CCAE():
    # data_dir_path  = 'D:\test\軸承資料'  #data_path
    #load data
    ...
    end_time = time.time()
    print(f"程式執行時間：{(end_time-start_time):.6f} 秒")
