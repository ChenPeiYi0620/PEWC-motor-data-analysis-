...
P_projected_LT_back=A^-1*[proj.projPoint(1);proj.projPoint(2)];
...
plot(P(1), P(2), 'ro', 'MarkerSize',10, 'LineWidth',2);
% 繪製投影點
plot(P_projected_LT_back(1), P_projected_LT_back(2), 'gs', 'MarkerSize',10, 'LineWidth',2);
% 畫出 P 與投影點之間的連線
plot([P(1) P_projected_LT_back(1)], [P(2) P_projected_LT_back(2)], 'k--', 'LineWidth',1.5);
